...
export default function OrderSummary() {
    ...
    return (
        <div className="order-box">
            <h2 className="section-title text-center">FORMA DE PAGO</h2>
            ...
            <div className="flex flex-wrap gap-3 justify-center">
                <button
                    ...
                    className="px-4 py-2 bg-red-700 text-white rounded-md hover:bg-red-800 transition-colors w-auto"
                ...
                <button
                    onClick={handlePay}
                    className="px-4 py-2 bg-green-600 text-white font-semibold rounded-md hover:bg-green-700 transition-colors w-auto"
                    aria-label="Pagar"
                >
